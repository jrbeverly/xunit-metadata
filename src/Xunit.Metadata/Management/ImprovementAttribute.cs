...
namespace Xunit.Metadata.Management
{
    ...
    /// <summary>An enhancement to an existing feature.</summary>
    [XunitCategory("Improvement")]
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, AllowMultiple = true)]
    public sealed partial class ImprovementAttribute : Attribute, ITraitAttribute
    {
        /// <inheritdoc />
        /// <summary>Associates the test with the Improvement category.</summary>
        ...
        /// <inheritdoc />
        /// <summary>Associates the test with the Improvement category and namespace.</summary>
        /// <param name="key">The issue namespace.</param>
        public ImprovementAttribute(string key)
        {
        ...
        /// <inheritdoc />
        /// <summary>Associates the test with the Improvement category for the specified namespace and issue id.</summary>
        /// <param name="key">The issue namespace.</param>
        /// <param name="id">A numeric identifier.</param>
        public ImprovementAttribute(string key, int id)
        {
            Key = key ?? throw new ArgumentNullException(nameof(key));
