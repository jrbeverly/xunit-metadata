...
The project icon is retrieved from [the Noun Project](https://thenounproject.com). The original source material has been altered for the purposes of the project. The icon is used under the terms of the [Public Domain](https://creativecommons.org/publicdomain/zero/1.0/).

The icon is by [Ana Paula Tello from the Noun Project](docs/icon/icon.json).